                ...
                <div class="card mb-3">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-10">
                            ...
                            <form id="createForm" method="post" action="{{ route('profiledept.update', Auth::user()->id) }}" class="m-2">
                                @method('PUT')
                                @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Update Data Departemen</h5>
                    {{-- <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button> --}}
                </div>
                <div class="modal-body">
                    <form id="createForm" action="{{ route('profiledept.updateFoto',Auth::user()->id) }}" method="POST" enctype="multipart/form-data" >
                        @method('PUT')
                        @csrf
                        <div class="form-group">
